...
public class Main {
    public static void main(String[] args) {
        ...
        LoanApplication app2 = new LoanApplication("Maria Ionescu", 600, 40000, true); // Scor credit mic
        LoanApplication app3 = new LoanApplication("Andrei Georgescu", 750, 20000, true); // Venit mic
        LoanApplication app4 = new LoanApplication("Elena Vasilescu", 800, 50000, false); // Neangajată
